...
<body>
<!-- 头部 -->
<div id="top"> <em> 昆山科技教师培训报名 </em> <span class='user'> &nbsp;&nbsp;&nbsp;&nbsp; {{Auth::user()->username}}</span> </div>
<!-- 左菜单 -->
<div id="left">
  <div class="menu_box">
    <div class="menu_block">
      <h3 class="menu_block_h">设置</h3>
      <ul class="menu_block_ul">
        <li> {{HTML::link('admin/sys/config','系统设置')}} </li>
       <!--  <li> {{HTML::link('admin/signup/list','报名字段')}} </li> -->
    ...
    <div class="menu_block">
      ...
      <ul class="menu_block_ul">
        <li> {{ HTML::link('admin/student/export', '导出原始数据') }} </li>
        <li> {{ HTML::link('admin/student/build', '导出签到表') }} </li>
      </ul>
    </div>
